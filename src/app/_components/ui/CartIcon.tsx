...
function CartIcon() {
  ...
  return (
    <div className="relative">
      ...
      <span
        className={`absolute top-[-4px] right-[-4px]  rounded-full md:size-[18px] size-4 border-pure-white border-[1px] flex items-center justify-center ${isCart ? "bg-primary-lm" : "bg-pure-black"} `}
      >
