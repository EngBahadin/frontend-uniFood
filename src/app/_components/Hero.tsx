  ...
  return (
    <article className="flex items-center justify-center bg-pure-white h-screen px-8 md:px-10 lg:px-20 md:justify-between flex-col md:flex-row md:-mt-10">
      <div className="flex flex-col md:items-start items-center gap-y-8  md:text-left text-center ">
        <h1
          className="text-primary lg:text-sub-heading-1-regular text-body-2-regular
        ...
        <button
          className="sm:w-48 sm:h-14 w-32 h-9 bg-primary bg- text-pure-white sm:text-text-1-semiBold text-text-3-medium grid place-items-center rounded-lg active:scale-95"
          onClick={scrollDown}
        >
          Order now
        </button>
